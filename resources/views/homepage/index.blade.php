...
<div class="container">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('kategori/satu') }}" class="text-decoration-none">
            <p class="card-text">Obat Generik</p>
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('kategori/dua') }}" class="text-decoration-none">
            <p class="card-text">Obat Paten</p>
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('kategori/tiga') }}" class="text-decoration-none">
            <p class="card-text">Alat-alat Kesehatan</p>
          </a>
        </div>
      </div>
    </div>
  ...
  <div class="row mt-4">
    <div class="col">
      <h5 class="text-center">Toko Obat Menggunakan Laravel</h5>
      <p>
